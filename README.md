...
1.  **Download** the latest `scrcpy_GUI.exe` from the [Releases]((https://github.com/sickseiha/Scrcpy_GUI/releases)). If you have all dependencies you can use `scrcpy_GUI.py` instead.
